...
export const identitySchemaTables = {
  identityUsers,
...
export type IdentityUserRecord = typeof identityUsers.$inferSelect;
export type IdentitySessionRecord = typeof identitySessions.$inferSelect;
