...
export const systemSettings = pgTable(
  'system_settings',
  {
    ...
    keyId: varchar('key_id', { length: 120 }),
  ...
  (table) => [
    ...
    check(
      ...
      sql`(${table.encryptedValue} is null and ${table.keyId} is null) or (${table.encryptedValue} is not null and ${table.keyId} is not null)`,
    ),
